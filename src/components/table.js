...
render(){
    ...
    let len = this.props.upProdData.length;
    let orgData =  len? Array.from(this.props.upProdData) :Array.from(this.props.products); 
    ...
    const row = orgData.map((i ,index) => <tr id = {index +"i"}>
...
upProdData: PropTypes.array.isRequired,
}; 

const mapStatetoProps = state => ({
products:state.prod.prodData,
upProdData:state.prod.upProdData
